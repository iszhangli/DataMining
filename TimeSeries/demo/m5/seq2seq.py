...
class Attention(nn.Module):
    ...
    def forward(self, hidden, encoder_outputs):
        ...
        hidden = hidden[2:3, :, :]  # The last layers

        # print("hidden size is",hidden.size())

        # repeat decoder hidden state src_len times
        # hidden = hidden.unsqueeze(1).repeat(1, src_len, 1)
        hidden = hidden.repeat(1, src_len, 1)  # copy step_time times  copy dim
        ...
        attention = self.v(energy).squeeze(2)  # ya suo dim
...
trainX = joblib.load('C:/ZhangLI/Codes/DataSet/m5-forecasting-accuracy/trainX.pkl')
trainy = joblib.load('C:/ZhangLI/Codes/DataSet/m5-forecasting-accuracy/trainy.pkl')
validX = joblib.load('C:/ZhangLI/Codes/DataSet/m5-forecasting-accuracy/validX.pkl')
validy = joblib.load('C:/ZhangLI/Codes/DataSet/m5-forecasting-accuracy/validy.pkl')
