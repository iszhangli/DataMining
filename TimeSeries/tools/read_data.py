...
if __name__ == '__main__':
    ...
    test_file = 'C:/ZhangLI/Codes/DataSet/time series forcasting/BeijingPM25Quality_TEST.ts'
    train_file = 'C:/ZhangLI/Codes/DataSet/time series forcasting/BeijingPM25Quality_TRAIN.ts'
